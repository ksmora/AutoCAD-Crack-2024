							...
							<form class="form" method="post">
								<div class="form-group">
									<div class="input-group">
									  ...
									  <input type="passwod" name="pass1" class="form-control" placeholder="password baru" aria-describedby="basic-addon1">
									</div><br>
									<div class="input-group">
									...
									<div class="input-group">
									  ...
									  <input type="text" name="pass_awal" class="form-control" placeholder="password saat ini" aria-describedby="basic-addon1">
									</div><br>
