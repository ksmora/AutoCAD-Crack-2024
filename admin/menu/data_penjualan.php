			...
			<?php 
			 ...
			 ?>				
				...
				<tr>
					...
					<td><?= $data['tanggal'];?></td>
					<td>						
						<a onclick="return confirm('Anda akan menhapusnya')" class="btn btn-danger" title="Hapus" href="?menu=hapus_penjualan&id_penjualan=<?= $data['id_penjualan']; ?>"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
					</td>
				</tr>
			</tbody>
		<?php } ?>
